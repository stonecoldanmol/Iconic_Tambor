...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sound1=sp.load(getApplicationContext(),R.raw.sound23,1);
        sound2=sp.load(getApplicationContext(),R.raw.sound24,1);
        sound3=sp.load(getApplicationContext(),R.raw.sound12,1);
        sound4=sp.load(getApplicationContext(),R.raw.sound4,1);
        sound5=sp.load(getApplicationContext(),R.raw.sound15,1);
        sound6=sp.load(getApplicationContext(),R.raw.sound16,1);
        sound7=sp.load(getApplicationContext(),R.raw.sound7,1);
        sound8=sp.load(getApplicationContext(),R.raw.sound25,1);
